...
class Cocktail {
  ...
  factory Cocktail.fromJson(Map<String, dynamic> json) {
    ...
    while (true){
      if(json["$zutaten$numberOfMaxZutatenAndMenge"] != null && json["$menge$numberOfMaxZutatenAndMenge"] != null){
        zutatenByMenge[json["$zutaten$numberOfMaxZutatenAndMenge"]] = json["$menge$numberOfMaxZutatenAndMenge"];
